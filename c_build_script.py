...
for procedure_name, procedure_data in procedures.items():
	if ((procedure_name in ["ckit_graphics_test", "ckg_pong"]) and os.getenv("IS_DEPENDENCY", "False") == "True") or ((procedure_name in ["ckit_graphics_test", "ckg_pong"]) and os.name != "nt"):
		continue
