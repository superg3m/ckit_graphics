...
CKIT_GRAPHICS_API void cksgl_draw_line(CKSGL inst, CKIT_Rectangle2D quad, CKIT_Color color);
CKIT_GRAPHICS_API void cksgl_draw_triangle(CKSGL inst, CKIT_Rectangle2D quad, CKIT_Color color);
